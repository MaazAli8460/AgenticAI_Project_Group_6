...
def build_phase1_prompt(user_prompt: str) -> str:
    ...
    return (
        ...
        "Ensure dialogue ends with a clear concluding line per scene and avoid trailing ellipses. "
        "Ensure voice gender is explicit and visual descriptions match that gender.\n\n"
