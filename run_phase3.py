...
def main() -> int:
    ...
    parser.add_argument("--input", type=Path, required=True, help="Phase 2 JSON path")
    parser.add_argument(
        "--output",
        type=Path,
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/outputs/phase3"),
        help="Folder to store video outputs and state JSON",
    )
    parser.add_argument(
        "--stdout",
        action="store_true",
